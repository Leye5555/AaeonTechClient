...
import { DELETE_RESPONSE } from "../constants/actionTypes";

const Response2 = ({ pathname, onClick, action }) => {
  const cardStatus = useSelector((state) => state.card);
